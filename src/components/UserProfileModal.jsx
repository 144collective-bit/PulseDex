...
export default function UserProfileModal() {
  ...
  return (
    <div className="modal-backdrop" onClick={closeProfileModal}>
      <div
        className="user-profile-modal glass-panel font-mono"
      ...
      >
        ...
        {/* Modal Header */}
        <div className="user-profile-hero" style={{ background: profile.bannerUrl }}>
        ...
        <div className="user-profile-body">
          {/* =========================================================================
             ...
             ========================================================================= */}
          {activeTab === 'profile' && (
            <div className="tab-pane-content font-mono animate-fade-in">
              {/* Account Status Card */}
        ...
        <div className="user-profile-modal-footer">
          <div className="footer-left-status">
            <span className="text-muted text-xs">Settings & identity automatically sync with Vault</span>
          </div>
          <button className="btn-primary font-mono" onClick={closeProfileModal}>
            Done
          </button>
        </div>
      </div>
