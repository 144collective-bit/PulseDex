...
export default function DexView({ onSelectPairForChart }) {
  ...
  return (
    <div className="dex-view-container">
      {/* =========================================================================
          TOP INSTITUTIONAL TELEMETRY & STATUS BAR
         ========================================================================= */}
      <div className="dex-subnav-bar glass-panel">
        <div className="dex-header-brand-title">
          <div className="dex-header-icon-badge">
            <Zap size={16} />
          </div>
          <div className="dex-header-text-group">
            <h2 className="dex-header-main-title">PulseChain DEX Aggregator</h2>
            <span className="dex-header-sub-title">Deep liquidity routing across PulseX v1, v2 & ecosystem AMMs with zero added surcharge</span>
          </div>
        </div>
        ...
        <div className="dex-subnav-stats desktop-only">
          <span className="dex-stat-chip">
            ...
            <span className="dex-stat-val text-white">PulseX v2 (Online)</span>
          </span>
          <span className="dex-stat-chip">
          ...
          <span className="dex-stat-chip">
            ...
            <span className="dex-stat-val font-mono text-pulse-green">3.0s</span>
          </span>
        </div>
      </div>

      {/* =========================================================================
          MAIN LIVE AGGREGATOR SWAP + COMPANION INTELLIGENCE SIDEBAR
         ========================================================================= */}
